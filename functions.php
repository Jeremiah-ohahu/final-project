...
echo <<<EOT
 ...
 <head>
    ...
    <!-- LInk for favIcon  -->
    <link rel="shortcut icon" href="./image/legends.png" type="image/x-icon">
...
<header class="header">
    ...
    <a href="#" class="logo"> <i class="fas fa-shopping-cart"></i> Discoverize </a>
...
<section class="footer">
    <div class="box-container"> <!--grid display-->
        ...
        <div class="box">
            <h3> <i class="fas fa-shopping-cart"></i> Discoverize</h3>
            <p>Discoverize is proudly owned by Ohahu Jeremiah, an ecommerce fashion plartform based in Abuja.</p>
            <div class="share">
        ...
        <div class="box">
            <h3>contact info</h3>
            <a href="#" class="links"> <i class="fas fa-phone"></i> +234-901-356-77-45 </a>
            <a href="#" class="links"> <i class="fas fa-envelope"></i> ohahujeremiah@gmail.com </a>
   ...
   <!--back to top section  ends-->
    ...
    <div class="credit"><span> &copy;2022 - $year </span> | all rights reserved </div>
        ...
        while ($row = mysqli_fetch_assoc($result)) {
          ...
          if (password_verify($password, $row['password'])) {
              ...
              <script type="text/javascript">
                ...
                window.location.pathname = "e-commerce-web-application/index.php";
              </script>
              <?php
          }else{
